...
class InvoiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSomething()
    {
        ...
        file_put_contents(__DIR__ . 'C:\test2.pdf', $pdf);
        $this->assertTrue(!empty($pdf));
    }
    private function _getOrderMock()
    {
        $this->_oOrderMock = $this
            ->getMockBuilder('C:\xampp\htdocs\vendor\quickshiftin\php-pdf-invoice\src\Spec\Order.php')
            ->getMock();
    ...
    {
        $oMockOrderItem = $this
            ->getMockBuilder('C:\xampp\htdocs\vendor\quickshiftin\php-pdf-invoice\src\Factory.php')
            ->getMock();
        ...
        $this->_setExp($oMockOrderItem, 'getPricePerUnit', $fPricePerUnit);
